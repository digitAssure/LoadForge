package digiassure.loadforge;

import digiassure.loadforge.dynamicclassloader.ClassFromFile;
import digiassure.loadforge.elements.PropReader;
import digiassure.loadforge.interfaces.*;
import digiassure.loadforge.runner.TaskRunner;
  ...
  //Vars
   ...
   static HashMap<String, TaskRunner> taskRunnerHashMap = new HashMap<>();
    ...
    public static void main(String[] arg) throws Exception {
        ...
        String path = LoadForge.class.getProtectionDomain().getCodeSource().getLocation().getPath();
